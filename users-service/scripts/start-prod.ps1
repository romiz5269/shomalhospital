# Production start Users — port 5002 (behind gateway)
...
if (-not (Test-Path $pub)) {
    ...
    if (Test-Path $fallback) {
        ...
        Write-Host "Copied auth public.pem -> users-service/keys/public.pem" -ForegroundColor Yellow
    } else {
...
Write-Host "Users PRODUCTION gunicorn w=$Workers :5002" -ForegroundColor Green
