...
export const STATUS_OPTIONS = [
  { value: "OPEN", label: "باز", color: "bg-emerald-100 text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-400" },
  { value: "IN_PROGRESS", label: "در حال بررسی", color: "bg-blue-100 text-blue-700 dark:bg-blue-950/50 dark:text-blue-400" },
  { value: "RESOLVED", label: "حل شده", color: "bg-violet-100 text-violet-700 dark:bg-violet-950/50 dark:text-violet-400" },
  { value: "CLOSED", label: "بسته", color: "bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400" },
] as const;
